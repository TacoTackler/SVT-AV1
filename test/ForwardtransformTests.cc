...
typedef void (*eb_av1_frwd_txfm_func)(int16_t *input, int32_t *coeff,
                                      uint32_t stride, TxType tx_type,
                                      uint8_t bitDepth);
eb_av1_frwd_txfm_func av1_frwd_txfm_func_ptr_array_base[9] = {
    eb_av1_fwd_txfm2d_16x16_avx2,
    eb_av1_fwd_txfm2d_32x32_avx2,
    eb_av1_fwd_txfm2d_64x64_avx2,
    eb_av1_fwd_txfm2d_16x64_avx2,
...
eb_av1_frwd_txfm_func av1_frwd_txfm_func_ptr_array_opt[9] = {
            ...
            for (int x = 0; x < 2; x++) {   // Bit Depth
                ...
                case 0:  // 16x16
                    for (int j = 0; j < 16; j++) {
                        ...
                        ASSERT(eb_buf_compare_s16(input,
                                                  input_opt,
